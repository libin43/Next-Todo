    ...
    return (
        <nav className="navbar bg-slate-600">
            <div className="nav-container flex justify-between min-h-[10vh] px-0">
                ...
                <div className={`nav-center xl:static absolute bg-slate-500 xl:min-h-fit min-h-[90vh] ${toggle ? 'left-[0%] duration-300': 'left-[-100%]'}  top-[10%] xl:w-auto w-full my-auto`}>
                    <ul className={`menu-container flex xl:flex-row flex-col gap-10 xl:p-0 py-5 ${toggle ? 'duration-1000 px-10': ''}  text-xl`}>
                        ...
                        <li className="menu-item">Filing</li>
                        <li className="menu-item">Home</li>
                        <li className="menu-item">Home</li>
                        <li className="menu-item">Home</li>
